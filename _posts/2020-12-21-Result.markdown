...
By using XDM atomic coefficients (![c6](http://www.sciweavers.org/tex2img.php?eq=C_6&bc=White&fc=Black&im=jpg&fs=12&ff=arev&edit=)), dispersion energy can be added to DFT energy. Damping function applied to avoid singularity as r --> 0. 
